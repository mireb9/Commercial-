...
export default function IndustriePage() {
  ...
  const products = [
    ...
    },
    {
      ...
      rating: 4.7,
      image: 'https://readdy.ai/api/search-image?query=Industrial%20air%20compressor%20machine%2C%20professional%20manufacturing%20equipment%2C%20heavy%20duty%20machinery%2C%20commercial%20photography%2C%20clean%20white%20background%2C%20centered%20composition%2C%20detailed%20view%2C%20premium%20industrial%20equipment%2C%20sharp%20focus&width=200&height=200&seq=compressor1&orientation=squarish'
    },
    {
      id: 13,
      ...
      rating: 4.6,
      image: 'https://readdy.ai/api/search-image?query=Industrial%20electric%20generator%2C%20professional%20power%20equipment%2C%20heavy%20duty%20machinery%2C%20commercial%20photography%2C%20clean%20white%20background%2C%20centered%20composition%2C%20detailed%20view%2C%20premium%20industrial%20equipment%2C%20sharp%20focus&width=200&height=200&seq=generator1&orientation=squarish'
    },
    {
      id: 14,
      ...
      rating: 4.8,
      image: 'https://readdy.ai/api/search-image?query=Industrial%20conveyor%20belt%20system%2C%20professional%20manufacturing%20equipment%2C%20automation%20machinery%2C%20commercial%20photography%2C%20clean%20white%20background%2C%20centered%20composition%2C%20detailed%20view%2C%20premium%20industrial%20equipment%2C%20sharp%20focus&width=200&height=200&seq=conveyor1&orientation=squarish'
    },
    {
      id: 15,
      ...
      price: '€5,500-€25,000',
      minOrder: '1 pièce',
      supplier: 'Hydraulic Tech Pro',
      rating: 4.5,
      image: 'https://readdy.ai/api/search-image?query=Industrial%20hydraulic%20press%20machine%2C%20professional%20manufacturing%20equipment%2C%20heavy%20duty%20machinery%2C%20commercial%20photography%2C%20clean%20white%20background%2C%20centered%20composition%2C%20detailed%20view%2C%20premium%20industrial%20equipment%2C%20sharp%20focus&width=200&height=200&seq=press1&orientation=squarish'
    },
    {
      id: 16,
      name: 'Équipement Soudage',
      price: '€890-€4,500',
      minOrder: '3 pièces',
      supplier: 'Welding Experts Co.',
      rating: 4.4,
      image: 'https://readdy.ai/api/search-image?query=Professional%20welding%20equipment%20machine%2C%20industrial%20tools%2C%20high-tech%20machinery%2C%20commercial%20photography%2C%20clean%20white%20background%2C%20centered%20composition%2C%20detailed%20view%2C%20premium%20industrial%20equipment%2C%20sharp%20focus&width=200&height=200&seq=welding1&orientation=squarish'
    }
  ];

  const subCategories = [
    { name: 'Machines-outils', count: '180K+' },
    { name: 'Équipements Lourds', count: '120K+' },
    { name: 'Automation', count: '95K+' },
    { name: 'Soudage & Découpe', count: '85K+' },
    { name: 'Électricité Industrielle', count: '140K+' },
    { name: 'Hydraulique', count: '110K+' }
  ];
      ...
      <nav className="fixed top-0 w-full bg-white shadow-sm z-50 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-lg font-semibold text-gray-900">Industrie</h1>
          </div>
          <div className="flex items-center space-x-3">
      ...
      <div className="pt-16 pb-20">
        ...
        <div className="px-4 py-4 bg-white border-b border-gray-100">
          <div className="relative">
            <input
              type="text"
              placeholder="Rechercher dans Industrie..."
              value={searchQuery}
        ...
        <div className="px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-sm font-medium text-gray-900">950K+ produits trouvés</h2>
